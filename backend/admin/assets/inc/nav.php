        ...
        <div class="logo-box">
            <a href="his_admin_dashboard.php" class="logo text-center">
                <span class="logo-lg">
                    ...
                    <span class="logo-lg-text-light fw-bold text-warning">Hospital MS</span>
                </span>
                <span class="logo-sm">
                    <!-- <span class="logo-sm-text-dark">U</span> -->
                    <!-- <img src="assets/images/logo-sm-white.png" alt="" height="24"> -->
                    <span class="logo-lg-text-light fw-bold text-warning">HMS</span>
        ...
        <ul class="list-unstyled topnav-menu topnav-menu-left m-0">
            ...
            <li class="dropdown d-none d-lg-block">
                ...
                <div class="dropdown-menu">
                    ...
                    <!-- item-->
                    <a href="his_admin_add_medical_record.php" class="dropdown-item d-none">
                    ...
                    <!-- item-->
                    <a href="his_admin_surgery_records.php" class="dropdown-item d-none">
